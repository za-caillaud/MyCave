...
if (!empty($_POST)) {
    ...
    //     $datas['picture'] = htmlspecialchars($_POST['picture']);
    // } else {
    //     $errors['picture'] = "erreur sur picture";
    // }
    ...
    if (!empty($datas['id'])) {
        $sql = "UPDATE vins SET name = :name, year= :year, grapes= :grapes, country= :country, region= :region, text= :text, picture= :picture WHERE id=" . $_POST['id'];
    } else {
        $sql = "UPDATE vins SET name = :name, year= :year, grapes= :grapes, country= :country, region= :region, text= :text, picture= :picture WHERE id=" . $_POST['id'];
    }
